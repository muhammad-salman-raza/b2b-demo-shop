...
use Pyz\Shared\Printer\PrinterConstants;
...
// ------------------------------ Printer ---------------------------------------
// ----------------------------------------------------------------------------
$config[PrinterConstants::PRINTNODE_BASE_URL] = getenv('PRINTNODE_BASE_URL') ?: 'https://api.printnode.com/';
$config[PrinterConstants::PRINTNODE_KEY] = getenv('PRINTNODE_KEY');
